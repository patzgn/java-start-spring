...
public class BikerentApplication {
    ...
    public static void main(String[] args) {
        ...
        BikeDto bike1 = new BikeDto(
                1L, "Kross Esker 4.0, 29 cali męski", "KRS12345", 30, 100);
        BikeDto bike2 = new BikeDto(
                2L, "Merida Kalahari 2020, 29 cali damski", "MK2020X9876", 25, 80);
        BikeDto bike3 = new BikeDto(
                3L, "Trek XSpeed 2, 29 cali męski", "TXS229M1234", 30, 120);
        BikeDto bike4 = new BikeDto(
                4L, "Superior XR Super, 26 cali damski", "SXRS26ASDF", 40, 150);
