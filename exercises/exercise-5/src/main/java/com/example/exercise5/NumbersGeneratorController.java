...
class NumbersGeneratorController {
    ...
    String getRandomNumber(@RequestParam(required = false) Integer from,
        ...
        int randomNumber = numberService.getRandomNumberFromRange(lowerBound, upperBound);
        return String.format("Losowa liczba z przedziału [%d; %d]: %d", lowerBound, upperBound, randomNumber);
    }
